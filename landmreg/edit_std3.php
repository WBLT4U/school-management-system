...
?>
	...
	$query = mysqli_query($conn, "select * from registration where Username='$admin'");
                ...
                $username = $row['Username']; ?> <b>Welcome!  </b> <?php echo $row['Username'];?> <span class="badge badge-info"> </span></a> </h5>
							</div>
...
<form id="drop_list" name= "drop_list" action="execeditstd3.php" method="post" enctype="multipart/form-data" onSubmit="return validateForm()">
	<input type="hidden" name="roomid" value="<?php echo $id=$_GET['id'] ?>">
      <p>Admission No. <br >
     <input name="admno" type="text" value="<?php echo $admno; ?>" class="ed" required /> <br >
