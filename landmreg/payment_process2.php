...
$query = mysqli_query($conn, "select * from registration where Username='$admin'");
                ...
                $id = $row['Username']; ?> <b>Welcome!  </b> <?php echo $row['Username'];?> <span class="badge badge-info"> </span></a> </h5>
                        ...
                        <br>
                        <br>
                        <h2>2ND TERM PAYMENT PROCESS</h2><br>
                        <br>
...
function getXMLHTTP() { //fuction to return the xml http object
	...
	function getState(countryId) {		
		...
		var strURL="findStatetwo.php?country="+countryId;
		var req = getXMLHTTP();
...
$result2 = mysqli_query($conn, "SELECT * FROM stdregistration2 WHERE stdid ='$id'");
...
?>
        ...
        <tr>
         ...
         <td> <select name="sclass">
            <option value="<?php echo $row['section'];  ?>"><?php echo $row['section'];  ?>
            </select></td>
         </tr>
         <tr>
...
$result = mysqli_query($conn, "UPDATE stdregistration2 SET authocode='$authocode', payment='$payment', admno='$admno', yearofadmission='$yofadm', class='$class', total='$regfee', price='$regfee', fpart='$fpart', term='$term', section='$sclass', stdstatus='$stdstatus' WHERE stdid='$stdid'");             
