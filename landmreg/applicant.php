...
checkboxes[i].checked = source.checked;
     ...
     if ($stats=="") {
      ...
      ?>
     <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="payment_processadmis.php?id=<?php echo $row['stdid'];?>" class="btn btn-success"><font size="2">Payment Process</font></a>
     <br><br> 
      <!---------------------their is a receipt--->   
   <?php } else { ?>
          <br><br>
          
          <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="printoutadmis.php?id=<?php echo $row['stdid'];?>" class="btn btn-danger"><font size="2">Paid Receipt</font></a>
          <br><br>
          </td>
    <?php }
         }    
