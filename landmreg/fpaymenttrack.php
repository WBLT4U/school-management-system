...
$query = mysqli_query($conn, "select * from registration where Username='$admin'");
                ...
                $id = $row['Username']; ?> <b>Welcome!  </b> <?php echo $row['Username'];?> <span class="badge badge-info"> </span></a> </h5>
                        ...
                        <h2 align="center">1ST TERM PAYMENT TRACKS</h2><br>
                        <br>
...
checkboxes[i].checked = source.checked;
      ...
      <tbody>
       <?php 
	$result=mysqli_query($conn, "SELECT * FROM stdregistrationtrack where payment='PARTPAID' AND term='FIRST TERM' order by stdid DESC");
