...
function myFunction()
{
	...
	<body >
		<a id="back" href="mpaymentadmis.php">Back</a>
        <br> <br>
        <div id="print">
    ...
    <td width="922" valign="top">
      <table width="920" border="1" cellpadding="3" cellspacing="1">
        <tr>
          ...
          <h1><strong>Applicant Form Slip</strong>.</h1></td>
        </tr>
        <tr bgcolor="#CCCCCC">
        ...
        <?php 
			include('../connect.php');
			$IDS=$_GET['id'];
			$result2 = mysqli_query($conn, "select * from applicants where stdid='$IDS'");
			
	$row=mysqli_fetch_array($result2);
	if(!$row){
	$_SESSION['msg'] = "Invalid Login Parameters" ;
	echo "<script> window.location.replace('stdwelcome.php')</script>";
//header("Location:stdwelcome.php");
  ...
  ?>
        ...
        <tr>
          ...
          <td colspan="2"><strong><?php echo $row['motherphone']; ?></strong></td>
          <td width="184" align="right" valign="top"><strong>Applicant ID:</strong></td>
          <td width="208" valign="top"><strong><?php echo $row['aplicant_id']; ?></strong></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="4">&nbsp;</td>
        ...
        <tr bgcolor="#999999">
          <td><strong>Section to be Admitted into</strong></td>
          <td colspan="4"></td>
        </tr>
        <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="mpaymentadmis.php"><input type="submit" name="button2" id="button2" value="Back" /></a>
    </p></td>
  </tr>
</table>
</body>
