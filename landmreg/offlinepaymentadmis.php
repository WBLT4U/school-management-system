...
<div class="col-md-12">
        ...
        <tr>
          <td colspan="4">Choose the month you want to pay for</td>
        </tr>
        <?php
 $IDS=$_GET['id'];
...
?>
 ...
 include('../connect.php');                
		...
		//$expdated = date('$expdates', strtotime('+$durations months'));
        	...
        	$result3=mysqli_query($conn, "UPDATE applicants SET payment ='$payment', payment_method ='$paymentmethod', Date_paid ='$datecreated' WHERE stdid ='$IDS'");			
