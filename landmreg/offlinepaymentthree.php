...
?>
 ...
 include('../connect.php');                
		...
		//$expdated = date('$expdates', strtotime('+$durations months'));
        	...
        	$result3=mysqli_query($conn, "UPDATE stdregistration3 SET payment ='$payment', payment_method ='$paymentmethod', fpayment ='$price', Date_paid ='$datecreated' WHERE stdid ='$IDS'");
