...
<br><br>
<strong>3RD TERM STUDENT REGISTRATION FEE FINANCIAL REPORTS </strong>
<br><br>
...
<table cellpadding="5" cellspacing="0" id="resultTable" border="1">
 ...
 $a=$_POST['from'];
                $b=$_POST['to'];
		$result2 = mysqli_query($conn, "SELECT * FROM stdregistration3 WHERE payment='PAID' AND Date_paid BETWEEN '$a' AND '$b'");
 ...
 $a=$_POST['from'];
                $b=$_POST['to'];
		$result3 = mysqli_query($conn, "SELECT * FROM stdregistration3 WHERE payment='PARTPAID' AND Date_paid BETWEEN '$a' AND '$b'");
...
// $cashier = $_SESSION['cashier'];
 $a=$_POST['from'];
                $b=$_POST['to'];
				  $result5 = mysqli_query($conn, "SELECT sum(price) FROM stdregistration3 WHERE payment='PAID' AND Date_paid BETWEEN '$a' AND '$b'");
				  
				  $result6 = mysqli_query($conn, "SELECT sum(fpart) FROM stdregistration3 WHERE payment='PARTPAID' AND Date_paid BETWEEN '$a' AND '$b'");
