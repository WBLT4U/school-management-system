...
<div class="well">
  ...
  <?php
	...
	$result=mysqli_query($conn, "UPDATE registration SET Password='$new_password' WHERE id='$id'");
...
<form action="" method="post" onSubmit="return validate();">
   ...
   New Password:<br><input type="password" name="new_password" id="new_password" value="" required /><br>
	Re-Type Password:<br><input type="password" id="cpassword" name="cpassword" value="" required /><br> <br>
