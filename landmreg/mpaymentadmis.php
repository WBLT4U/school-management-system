...
$query = mysqli_query($conn, "select * from registration where Username='$admin'");
                ...
                $id = $row['Username']; ?> <b>Welcome!  </b> <?php echo $row['Username'];?> <span class="badge badge-info"> </span></a> </h5>
                        ...
                        <h2 align="center">PAYMENT RECORDS</h2><br>
                        <br>
...
checkboxes[i].checked = source.checked;
      ...
      <tbody>
       <?php 
	$result=mysqli_query($conn, "SELECT * FROM applicants order by stdid DESC");
   ...
   <?php }elseif ($stats=="PAID") {
      ?>
      <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="printoutadmis.php?id=<?php echo $row['stdid'];?>" class="btn btn-success"><font size="2">Receipt</font></a>
      <!---------------------their is a receipt--->   
   <?php } else { ?>
          <br>
          <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="paymentadmis.php?id=<?php echo $row['stdid'];?>" class="btn btn-success"><font size="2">Online Payment</font></a>
          <br><br>
          
          <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="offlinepaymentadmis.php?id=<?php echo $row['stdid'];?>" class="btn btn-danger"><font size="2">Offline Payment</font></a>
          </td>
    <?php }
         }    
     ?>
