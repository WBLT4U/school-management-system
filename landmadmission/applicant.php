							...
							<div class="card">
								...
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <p><a href="addapplicant.php" class="btn btn-success"><i class="glyphicon-plus"></i> &nbsp;Add Applicant</a>&nbsp;
...
checkboxes[i].checked = source.checked;
          ...
          <td bgcolor="#FFFFFF"><?php echo $row['aplicant_id'];?></td>
          <td bgcolor="#FFFFFF"><?php echo $row['class'];?></td>
          <td bgcolor="#FFFFFF"><?php echo $row['payment'];?></td>
                   <td bgcolor="#FFFFFF"><img class="img-rounded" src="../birthcert/<?php echo $row['pbirthcert']; ?>" width="60" height="60" /></td>
     ...
     <a href="edit_applicant.php<?php echo '?id='.$id; ?>" class="btn btn-danger"> Edit</a>
     <br> <br>
     <a href="uploadimages.php<?php echo '?id='.$id; ?>" class="btn btn-success"> Upload Images</a>
   ...
   <?php } else { ?>
          <br><br>
               <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="printout.php?id=<?php echo $row['stdid'];?>" class="btn btn-success"><font size="2">Paid Receipt</font></a>
          <br><br>
          </td>
    <?php }
         }    
