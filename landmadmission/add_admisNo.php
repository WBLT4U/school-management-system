		...
		if (req) {
			...
			req.onreadystatechange = function() {
				if (req.readyState == 4) {
					// only if "OK"
					if (req.status == 200) {						
						document.getElementById('statdiva').innerHTML=req.responseText;	
...
$section = $row['section'];
?>
        <input type="hidden" id="stdid" class="form-control" name = "stdid" value="<?php echo $row['stdid'];  ?>" readonly >
        ...
        <tr>
         ...
         <td> 
         <input name="admno" type="text" class="ed" id="admno" value="<?php $rand = rand(1000,100000); $slash = "/"; $sec = $section; $sname = "WBLT/"; $pid = $sname.$sec.$slash.$rand ; echo $pid ; ?>" readonly />
         </td>
         </tr>
         <tr>
         ...
         <td> 
         <input name="sclass" type="text" class="ed" value="<?php echo $row['section'];  ?>" id="sclass" readonly />
         </td>
         </tr>
         <tr>
