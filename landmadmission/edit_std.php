...
//$id=$_GET['id'];
$id=$_GET['id'];
$result2 = mysqli_query($conn, "SELECT * FROM stdregistration WHERE stdid='$id' AND payment='PAID'");
		...
		
		{
			...
			echo "<script>alert('Applicant Paid!. It cannot be edited pls contact the Director.'); window.location='stdreg.php';</script>";
...
?>
  ...
  <?php
	include('../connect.php');
	$id=$_GET['id'];
	$result = mysqli_query($conn, "SELECT * FROM stdregistration where stdid='$id'");
...
?>
<form id="drop_list" name= "drop_list" action="execeditstd.php" method="post" enctype="multipart/form-data" onSubmit="return validateForm()">
...
function getXMLHTTP() { //fuction to return the xml http object
	...
	function getState(countryId) {		
		...
		var strURL="findStatereg.php?country="+countryId;
		var req = getXMLHTTP();
