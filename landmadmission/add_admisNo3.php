...
$query = mysqli_query($conn, "select * from admission where Username='$admin'");
                ...
                $id = $row['Username']; ?> <b>Welcome!  </b> <?php echo $row['Username'];?> <span class="badge badge-info"> </span></a> </h5>
                        ...
                        <br>
                        <br>
                        <h2>3RD TERM PAYMENT PROCESS</h2><br>
                        <br>
...
function getXMLHTTP() { //fuction to return the xml http object
	...
	function getState(countryId) {		
		...
		var strURL="findStatethreereg.php?country="+countryId;
		var req = getXMLHTTP();
	...
	function getStat(countryId) {		
		...
		var strURL="findState3.php?country="+countryId;
		var req = getXMLHTTP();
...
$result2 = mysqli_query($conn, "SELECT * FROM stdregistration3 WHERE stdid ='$id'");
...
?>
        ...
        <tr>
         ...
         <td> <input name="admno" type="text" class="ed" id="admno" value="<?php echo $row['admno'];  ?>" readonly /></td>
         </tr>
         <tr>
         ...
         <td> <input name="yofadm" type="text" class="ed" id="yofadm" value="<?php echo $row['yearofadmission'];  ?>" readonly /></td>
         </tr>
         <tr>
 ...
 //$a=$_POST['from'];
                //$b=$_POST['to'];
		$result = mysqli_query($conn, "SELECT * FROM reg_charge3");
...
$result = mysqli_query($conn, "UPDATE stdregistration3 SET authocode='$authocode', payment='$payment', admno='$admno', yearofadmission='$yofadm', class='$class', total='$regfee', price='$regfee', fpart='$fpart', term='$term', section='$sclass', stdstatus='$stdstatus' WHERE stdid='$stdid'");             
