...
$query = mysqli_query($conn, "select * from admission where Username='$admin'");
                ...
                $id = $row['Username']; ?> <b>Welcome!  </b> <?php echo $row['Username'];?> <span class="badge badge-info"> </span></a> </h5>
						...
						<br>
                        <br>
                        <h2>SECOND TERM (2ND TERM) STUDENT REGISTRATION</h2><br>
                        <br>
...
checkboxes[i].checked = source.checked;
     ...
     if ($stats=="") {
      ...
      ?>
     <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="add_admisNo2.php?id=<?php echo $row['stdid'];?>" class="btn btn-success"><font size="2">Generate 2nd Term Invoice </font></a>
     <br><br> 
     <a href="edit_std2.php<?php echo '?id='.$id; ?>" class="btn btn-danger"> Edit</a>
     <br> <br>
      <!---------------------their is a receipt--->   
   ...
   <?php } else { ?>
      ...
      <a href="edit_std2.php<?php echo '?id='.$id; ?>" class="btn btn-success"> Edit</a>
     
          <br><br> 
          
          <a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="printout2.php?id=<?php echo $row['stdid'];?>" class="btn btn-danger"><font size="2">Paid Receipt</font></a>
          <br><br>
          </td>
    <?php }
         }    
